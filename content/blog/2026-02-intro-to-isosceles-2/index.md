...
For annotation, Stanza's GSD model produces the most consistent UD v2 output. I initially tried the default "combined" model, which was trained on multiple treebanks, but the mixture of annotation conventions there tended to produce inconsistent results, as Stanza's own [documentation](https://stanfordnlp.github.io/stanza/combined_models.html) warns.
