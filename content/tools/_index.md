...
[Repository on GitHub →](https://github.com/myersm0/isosceles)

## Montre
A corpus query engine, written in Rust. Designed for annotated literary corpora. First-class support for dealing with parallel texts.
